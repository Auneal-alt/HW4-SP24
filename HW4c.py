...
# Marlesha did this problem, I(Austin) did a walk through to check and didnt see a reason to change it.
import numpy as np     # used for making matrixes
from scipy.linalg import solve    # used for solving the matrixes
